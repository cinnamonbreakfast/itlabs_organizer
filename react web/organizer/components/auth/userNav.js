...
const UserNav = () => {
    ...
    return (
        <div className={styles.userTab}>
            <div className={styles.envelope + ' ' + (user.invitations && user.invitations.length && styles.jumpy)} onClick={e => router.push('/invitations')}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12.8" viewBox="0 0 16 12.8"><path d="M15.6,4H4.4A2.4,2.4,0,0,0,2,6.4v8a2.4,2.4,0,0,0,2.4,2.4H15.6A2.4,2.4,0,0,0,18,14.4v-8A2.4,2.4,0,0,0,15.6,4Zm-.328,1.6-4.7,4.7a.8.8,0,0,1-1.136,0l-4.7-4.7ZM16.4,14.4a.8.8,0,0,1-.8.8H4.4a.8.8,0,0,1-.8-.8V6.728l4.7,4.7a2.4,2.4,0,0,0,3.392,0l4.7-4.7Z" transform="translate(-2 -4)"/></svg>

                {   user.invitations && user.invitations.length > 0 && <div></div>  }
            </div>
